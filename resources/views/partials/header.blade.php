...
<head>
    ...
    <!--== Icofont Icon CSS ==-->
    <link href="{{ asset('theme/assets/css/icofont.css') }}" rel="stylesheet" />
    <!--== Swiper CSS ==-->
    <link href="{{ asset('theme/assets/css/swiper.min.css') }}" rel="stylesheet" />
    <!--== Fancybox Min CSS ==-->
    <link href="{{ asset('theme/assets/css/fancybox.min.css') }}" rel="stylesheet" />
    <!--== Aos Min CSS ==-->
    <link href="{{ asset('theme/assets/css/aos.min.css') }}" rel="stylesheet" />
